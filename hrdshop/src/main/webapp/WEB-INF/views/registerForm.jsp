	...
	<form id='reg_form' onsubmit='return register()' method='post'>
		<table>
			<tr>
				...
				<td>
					<input id='mem_id' type='text' name='member_id' onchange='idinput_change()'  required>
					<input type='button' value='사용가능체크' onclick='id_check()'>
				</td>
			</tr>
			<tr>
				<td>비밀번호</td>
			...
			<tr>
				<td colspan=2 style="text-align: center">
					<input id='reg_button' type='submit' value='가입'>
					<input id='list_button' type='button'  value='조회' onclick='list_member()'>
				</td>
			</tr>
		</table>
	</form>
